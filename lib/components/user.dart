...
class User extends ChangeNotifier {
  ...
  { name = nUser; hobbies = hUser; avatarSprite = aUser; }
  ...
  void addMeet(String name, String hobbies, String avatar) { meets.add(User(name, hobbies, avatar)); }
  void addFriend(String name, String hobbies, String avatar) { friends.add(User(name, hobbies, avatar)); }
